...
namespace Drupal\varbase_media_instagram\Hook;
...
/**
 * Hook implementations for the VarbaseMediaInstagramHooks module.
 */
class VarbaseMediaInstagramHooks {

  /**
   * Constructs a VarbaseMediaInstagramHooks object.
   *
